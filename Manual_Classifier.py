    ...
    for entry in json_data:
        if "Classification" not in entry:
            ...
            classification = input(
                "Enter the classification (0 or 1, or 'q' to quit, or 'n' for next tweet): ")
...
classified_tweets_count = update_classification(
    existing_data, tokenized_json_file_path)

print(
    f"Classification updated successfully. Total classified tweets in {tokenized_json_file_path}: {classified_tweets_count}")
